...
#[OA\Schema(
    ...
    properties: [
        new OA\Property(property: 'id', type: 'string', format: 'uuid', description: 'Internal UUID'),
        ...
        new OA\Property(property: 'disabled', type: 'boolean', description: 'Whether the account is disabled'),
        new OA\Property(property: 'createdAt', type: 'string', format: 'date-time'),
        new OA\Property(property: 'updatedAt', type: 'string', format: 'date-time'),
    ],
)]
final class AdminUserResource extends AbstractResource
{
