...
final class PlayerPreferencesAdapter implements PlayerPreferencesPortInterface
{
    private const PREFERENCE_TYPE = 'player';
    ...
    public function saveForUser(Uuid $userId, array $payload, int $version): int
    {
        ...
        if ($entity !== null) {
            ...
            $newVersion = 1;
            $entity = new PlayerPreferencesEntity(Uuid::generate());
