...
#[ORM\Entity]
#[ORM\Table(name: 'user_accent_colors')]
#[ORM\UniqueConstraint(name: 'user_accent_colors_user_id_key', columns: ['user_id'])]
class UserAccentColorEntity
{
    #[ORM\Id]
    ...
    #[ORM\Column(type: 'text', options: ['default' => 'violet'])]
