...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The "two_factor.confirm" middleware acts as a gatekeeper to a route by asking
    ...
    */
    ...
    'issuer' => env('OTP_TOTP_ISSUER', config('app.name')),
