 ...
 */
import type { MoviesIndex200MetaLinksItemUrl } from "./moviesIndex200MetaLinksItemUrl";

export type MoviesIndex200MetaLinksItem = {
  url: MoviesIndex200MetaLinksItemUrl;
  label: string;
  active: boolean;
};
