...
export type ApplyMetadataRequestSource =
  (typeof ApplyMetadataRequestSource)[keyof typeof ApplyMetadataRequestSource];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ApplyMetadataRequestSource = {
