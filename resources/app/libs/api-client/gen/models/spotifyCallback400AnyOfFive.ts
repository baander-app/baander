 ...
 */
import type { SpotifyCallback400AnyOfFiveError } from "./spotifyCallback400AnyOfFiveError";

export type SpotifyCallback400AnyOfFive = {
  error: SpotifyCallback400AnyOfFiveError;
};
