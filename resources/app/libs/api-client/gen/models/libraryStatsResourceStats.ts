 ...
 */
import type { LibraryStatsResourceStatsFormatted } from "./libraryStatsResourceStatsFormatted";
import type { LibraryStatsResourceStatsRaw } from "./libraryStatsResourceStatsRaw";

export type LibraryStatsResourceStats = {
  formatted: LibraryStatsResourceStatsFormatted;
  /** Raw numerical values for calculations and sorting.
Only included when raw stats are available. */
  raw?: LibraryStatsResourceStatsRaw;
};
