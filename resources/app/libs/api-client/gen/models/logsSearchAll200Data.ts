 ...
 */
import type { LogsSearchAll200DataTotalMatches } from "./logsSearchAll200DataTotalMatches";

export type LogsSearchAll200Data = {
  pattern: string;
  caseSensitive: string;
  totalFilesSearched: string;
  filesWithMatches: string;
  totalMatches: LogsSearchAll200DataTotalMatches;
  searchTimeMs: string;
  /**
   * @minItems 0
   * @maxItems 0
