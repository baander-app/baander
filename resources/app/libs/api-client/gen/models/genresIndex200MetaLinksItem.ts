 ...
 */
import type { GenresIndex200MetaLinksItemUrl } from "./genresIndex200MetaLinksItemUrl";

export type GenresIndex200MetaLinksItem = {
  url: GenresIndex200MetaLinksItemUrl;
  label: string;
  active: boolean;
};
