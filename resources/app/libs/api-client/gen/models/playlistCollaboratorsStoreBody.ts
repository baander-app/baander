 ...
 */
import type { PlaylistCollaboratorsStoreBodyRole } from "./playlistCollaboratorsStoreBodyRole";

export type PlaylistCollaboratorsStoreBody = {
  user_id: number;
  role?: PlaylistCollaboratorsStoreBodyRole;
};
