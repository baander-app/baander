...
export type StreamSongDirect416AnyOfError =
  (typeof StreamSongDirect416AnyOfError)[keyof typeof StreamSongDirect416AnyOfError];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const StreamSongDirect416AnyOfError = {
  "Invalid_range:_end_before_start": "Invalid range: end before start",
} as const;
