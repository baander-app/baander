 ...
 */
import type { PlaylistStatisticsRecordPlay200Message } from "./playlistStatisticsRecordPlay200Message";

export type PlaylistStatisticsRecordPlay200 = {
  message: PlaylistStatisticsRecordPlay200Message;
};
