 ...
 */
import type { SpotifyCallback500AnyOfThreeError } from "./spotifyCallback500AnyOfThreeError";

export type SpotifyCallback500AnyOfThree = {
  error: SpotifyCallback500AnyOfThreeError;
};
