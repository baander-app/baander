...
export type OauthDeviceApproveBodyAction =
  (typeof OauthDeviceApproveBodyAction)[keyof typeof OauthDeviceApproveBodyAction];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const OauthDeviceApproveBodyAction = {
  approve: "approve",
  deny: "deny",
} as const;
