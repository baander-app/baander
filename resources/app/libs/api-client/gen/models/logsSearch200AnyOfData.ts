 ...
 */
import type { LogsSearch200AnyOfDataResultsItem } from "./logsSearch200AnyOfDataResultsItem";

export type LogsSearch200AnyOfData = {
  pattern: string;
  caseSensitive: boolean;
  totalMatches: number;
  searchTimeMs: number;
  results: LogsSearch200AnyOfDataResultsItem[];
};
