...
export type SpotifyAuthorize500Error =
  (typeof SpotifyAuthorize500Error)[keyof typeof SpotifyAuthorize500Error];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SpotifyAuthorize500Error = {
  Spotify_client_ID_not_configured: "Spotify client ID not configured",
} as const;
