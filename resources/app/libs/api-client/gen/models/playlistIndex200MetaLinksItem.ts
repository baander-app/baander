 ...
 */
import type { PlaylistIndex200MetaLinksItemUrl } from "./playlistIndex200MetaLinksItemUrl";

export type PlaylistIndex200MetaLinksItem = {
  url: PlaylistIndex200MetaLinksItemUrl;
  label: string;
  active: boolean;
};
