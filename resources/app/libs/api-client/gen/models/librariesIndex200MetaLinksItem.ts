 ...
 */
import type { LibrariesIndex200MetaLinksItemUrl } from "./librariesIndex200MetaLinksItemUrl";

export type LibrariesIndex200MetaLinksItem = {
  url: LibrariesIndex200MetaLinksItemUrl;
  label: string;
  active: boolean;
};
