 ...
 */
import type { LogsSearchAll200AnyOfDataResultsItem } from "./logsSearchAll200AnyOfDataResultsItem";

export type LogsSearchAll200AnyOfData = {
  pattern: string;
  ...
  totalMatches: number;
  searchTimeMs: number;
  results: LogsSearchAll200AnyOfDataResultsItem[];
};
