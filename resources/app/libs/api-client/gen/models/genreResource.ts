 ...
 */
import type { GenreResourceCreatedAt } from "./genreResourceCreatedAt";
import type { GenreResourceUpdatedAt } from "./genreResourceUpdatedAt";
...
export interface GenreResource {
  ...
  name: string;
  slug: string;
  createdAt: GenreResourceCreatedAt;
  updatedAt: GenreResourceUpdatedAt;
  /** Songs relation */
  songs?: SongResource[];
}
