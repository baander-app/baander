...
export type MetadataSync200Message =
  (typeof MetadataSync200Message)[keyof typeof MetadataSync200Message];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const MetadataSync200Message = {
  Metadata_sync_jobs_queued_successfully:
    "Metadata sync jobs queued successfully",
} as const;
