 ...
 */
import type { PlaylistStatisticsRecordView200Message } from "./playlistStatisticsRecordView200Message";

export type PlaylistStatisticsRecordView200 = {
  message: PlaylistStatisticsRecordView200Message;
};
