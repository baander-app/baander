 ...
 */
import type { AuthLogin200AccessTokenExpiresIn } from "./authLogin200AccessTokenExpiresIn";

export type AuthLogin200AccessToken = {
  token_id: string;
  token_type: string;
  expires_in: AuthLogin200AccessTokenExpiresIn;
  scopes: string[];
};
