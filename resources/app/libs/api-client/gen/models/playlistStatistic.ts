 ...
 */
import type { PlaylistStatisticCreatedAt } from "./playlistStatisticCreatedAt";
import type { PlaylistStatisticUpdatedAt } from "./playlistStatisticUpdatedAt";
...
export interface PlaylistStatistic {
  ...
  shares: number;
  favorites: number;
  created_at: PlaylistStatisticCreatedAt;
  updated_at: PlaylistStatisticUpdatedAt;
}
