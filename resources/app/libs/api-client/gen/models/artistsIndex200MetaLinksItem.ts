 ...
 */
import type { ArtistsIndex200MetaLinksItemUrl } from "./artistsIndex200MetaLinksItemUrl";

export type ArtistsIndex200MetaLinksItem = {
  url: ArtistsIndex200MetaLinksItemUrl;
  label: string;
  active: boolean;
};
