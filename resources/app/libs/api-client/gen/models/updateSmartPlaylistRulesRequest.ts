 ...
 */
import type { UpdateSmartPlaylistRulesRequestRulesItemItem } from "./updateSmartPlaylistRulesRequestRulesItemItem";

export interface UpdateSmartPlaylistRulesRequest {
  rules: UpdateSmartPlaylistRulesRequestRulesItemItem[][];
}
