 ...
 */
import type { SystemInfoPhp200ItemValuesItemValue } from "./systemInfoPhp200ItemValuesItemValue";

export type SystemInfoPhp200ItemValuesItem = {
  key: string;
  value: SystemInfoPhp200ItemValuesItemValue;
};
