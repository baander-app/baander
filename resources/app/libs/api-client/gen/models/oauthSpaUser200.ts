 ...
 */
import type { OauthSpaUser200EmailVerifiedAt } from "./oauthSpaUser200EmailVerifiedAt";

export type OauthSpaUser200 = {
  id: string;
  name: string;
  email: string;
  email_verified_at: OauthSpaUser200EmailVerifiedAt;
  created_at: string;
  updated_at: string;
};
