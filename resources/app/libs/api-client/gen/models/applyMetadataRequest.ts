 ...
 */
import type { ApplyMetadataRequestEntityType } from "./applyMetadataRequestEntityType";
import type { ApplyMetadataRequestSource } from "./applyMetadataRequestSource";

export interface ApplyMetadataRequest {
  entity_type: ApplyMetadataRequestEntityType;
  entity_id: number;
  source: ApplyMetadataRequestSource;
  external_id: string;
}
