 ...
 */
import type { PlaylistCollaboratorsDestroy200Message } from "./playlistCollaboratorsDestroy200Message";

export type PlaylistCollaboratorsDestroy200 = {
  message: PlaylistCollaboratorsDestroy200Message;
};
