 ...
 */
import type { PlaylistCollaboratorsStore200Message } from "./playlistCollaboratorsStore200Message";

export type PlaylistCollaboratorsStore200 = {
  message: PlaylistCollaboratorsStore200Message;
};
