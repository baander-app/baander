 ...
 */
import type { LibraryResourceLastScan } from "./libraryResourceLastScan";
import type { LibraryResourceCreatedAt } from "./libraryResourceCreatedAt";
...
export interface LibraryResource {
  ...
  type: string;
  order: number;
  lastScan: LibraryResourceLastScan;
  createdAt: LibraryResourceCreatedAt;
  updatedAt: LibraryResourceUpdatedAt;
}
