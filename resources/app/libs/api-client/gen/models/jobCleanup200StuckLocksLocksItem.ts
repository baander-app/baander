 ...
 */
import type { JobCleanup200StuckLocksLocksItemAgeHours } from "./jobCleanup200StuckLocksLocksItemAgeHours";

export type JobCleanup200StuckLocksLocksItem = {
  key: string;
  ttl: number;
  age_hours: JobCleanup200StuckLocksLocksItemAgeHours;
};
