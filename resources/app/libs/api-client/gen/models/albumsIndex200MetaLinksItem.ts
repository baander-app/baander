 ...
 */
import type { AlbumsIndex200MetaLinksItemUrl } from "./albumsIndex200MetaLinksItemUrl";

export type AlbumsIndex200MetaLinksItem = {
  url: AlbumsIndex200MetaLinksItemUrl;
  label: string;
  active: boolean;
};
