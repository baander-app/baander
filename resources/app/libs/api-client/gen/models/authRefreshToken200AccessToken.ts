 ...
 */
import type { AuthRefreshToken200AccessTokenExpiresIn } from "./authRefreshToken200AccessTokenExpiresIn";

export type AuthRefreshToken200AccessToken = {
  token_id: string;
  token_type: string;
  expires_in: AuthRefreshToken200AccessTokenExpiresIn;
  scopes: string[];
};
