 ...
 */
import type { UserTokensIndex200MetaLinksItemUrl } from "./userTokensIndex200MetaLinksItemUrl";

export type UserTokensIndex200MetaLinksItem = {
  url: UserTokensIndex200MetaLinksItemUrl;
  label: string;
  active: boolean;
};
