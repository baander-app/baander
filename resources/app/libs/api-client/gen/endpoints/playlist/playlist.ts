...
export const getPlaylistIndexInfiniteQueryKey = () => {
  return ["infinite", `/api/playlists`] as const;
};
...
export const getPlaylistShowInfiniteQueryKey = (
  playlist?: string,
  params?: PlaylistShowParams
) => {
  return [
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getPlaylistShowInfiniteQueryKey(playlist, params);
...
export const getPlaylistStatisticsInfiniteQueryKey = (playlist?: string) => {
  return ["infinite", `/api/playlists/${playlist}/statistics`] as const;
};
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getPlaylistStatisticsInfiniteQueryKey(playlist);
