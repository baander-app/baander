...
export const getHorizonQueuesMetricsIndexInfiniteQueryKey = () => {
  return ["infinite", `/-/horizon/api/metrics/queues`] as const;
};
...
export const getHorizonQueuesMetricsShowInfiniteQueryKey = (id?: string) => {
  return ["infinite", `/-/horizon/api/metrics/queues/${id}`] as const;
};
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getHorizonQueuesMetricsShowInfiniteQueryKey(id);
