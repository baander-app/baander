 ...
 * @summary Get a paginated collection of user's OAuth tokens
 */
...
export const getUserTokensIndexInfiniteQueryKey = (
  user?: string,
  params?: UserTokensIndexParams
) => {
  return [
 ...
 * @summary Revoke a specific OAuth token
 */
export const userTokensRevoke = (
  ...
  return customInstance<void>(
    { url: `/api/users/tokens/${tokenId}`, method: "DELETE" },
    options
  );
};
...
> => {
  ...
  > = (props) => {
    ...
    return userTokensRevoke(tokenId, requestOptions);
  };
