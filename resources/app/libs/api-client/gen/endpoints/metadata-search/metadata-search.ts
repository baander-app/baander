...
export const getMetadataSearchAlbumInfiniteQueryKey = (album?: number) => {
  return ["infinite", `/api/metadata/search/album/${album}`] as const;
};
...
export const getMetadataSearchFuzzyAlbumInfiniteQueryKey = (album?: number) => {
  return ["infinite", `/api/metadata/search/album/${album}/fuzzy`] as const;
};
...
>(
  ...
  const queryKey =
    ...
    getMetadataSearchFuzzyAlbumInfiniteQueryKey(album);
