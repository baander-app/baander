...
export const getAlbumsIndexInfiniteQueryKey = (
  library?: string,
  params?: AlbumsIndexParams
) => {
  return [
...
export const getAlbumsShowInfiniteQueryKey = (
  library?: string,
  album?: string
) => {
  return ["infinite", `/api/libraries/${library}/albums/${album}`] as const;
};
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getAlbumsShowInfiniteQueryKey(library, album);
