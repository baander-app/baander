...
export const getMoviesIndexInfiniteQueryKey = (library?: string) => {
  return ["infinite", `/api/libraries/${library}/movies`] as const;
};
...
export const getMoviesShowInfiniteQueryKey = (
  library?: string,
  movie?: string
) => {
  return ["infinite", `/api/libraries/${library}/movies/${movie}`] as const;
};
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getMoviesShowInfiniteQueryKey(library, movie);
