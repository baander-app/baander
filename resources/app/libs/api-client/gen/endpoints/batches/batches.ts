...
export const getHorizonJobsBatchesIndexInfiniteQueryKey = () => {
  return ["infinite", `/-/horizon/api/batches`] as const;
};
...
export const getHorizonJobsBatchesIndexInfiniteQueryOptions = <
  TData = InfiniteData<HorizonJobsBatchesIndex200>,
...
>(options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getHorizonJobsBatchesIndexInfiniteQueryKey();
...
export const getHorizonJobsBatchesIndexQueryOptions = <
  TData = HorizonJobsBatchesIndex200,
  TError = ErrorType<unknown>
>(options?: {
  query?: Partial<
    UseQueryOptions<
...
export const getHorizonJobsBatchesShowInfiniteQueryKey = (id?: string) => {
  return ["infinite", `/-/horizon/api/batches/${id}`] as const;
};
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getHorizonJobsBatchesShowInfiniteQueryKey(id);
