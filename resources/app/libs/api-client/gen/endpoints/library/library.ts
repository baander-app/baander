...
export const getLibrariesIndexInfiniteQueryKey = (
  params?: LibrariesIndexParams
) => {
  return ["infinite", `/api/libraries`, ...(params ? [params] : [])] as const;
};
...
export const getLibraryShowInfiniteQueryKey = (slug?: string) => {
  return ["infinite", `/api/libraries/${slug}`] as const;
};
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getLibraryShowInfiniteQueryKey(slug);
