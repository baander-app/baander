...
export const getHorizonWorkloadIndexInfiniteQueryKey = () => {
  return ["infinite", `/-/horizon/api/workload`] as const;
};
...
>(options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getHorizonWorkloadIndexInfiniteQueryKey();
