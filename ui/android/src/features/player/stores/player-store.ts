/**
 * Player store -- Zustand store for Android app playback state.
 *
 * Manages queue, transport controls, and playback modes.
 * Persists volume, mute, shuffle, and repeat preferences.
 */
