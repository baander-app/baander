...
function handleMenuAction(actionId: string) {
  switch (actionId) {
    ...
    // Playback (forward to renderer via specific IPC channels)
    case MenuActionId.PlaybackToggle:
      return sendToFocused('baander:playback:toggle');
    case MenuActionId.PlaybackNext:
      return sendToFocused('baander:playback:next');
    case MenuActionId.PlaybackPrev:
      return sendToFocused('baander:playback:previous');
    case MenuActionId.PlaybackSeekForward:
      return sendToFocused('baander:playback:seek-forward');
    case MenuActionId.PlaybackSeekBackward:
      return sendToFocused('baander:playback:seek-backward');
