...
class CrossCorrelation extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create CrossCorrelation algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing CrossCorrelation: " . $e->getMessage(), 0, $e);
        }
    }
