...
class Histogram extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Histogram algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Histogram: " . $e->getMessage(), 0, $e);
        }
    }
