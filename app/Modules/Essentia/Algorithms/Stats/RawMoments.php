...
class RawMoments extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create RawMoments algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing RawMoments: " . $e->getMessage(), 0, $e);
        }
    }
