...
class PowerMean extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create PowerMean algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing PowerMean: " . $e->getMessage(), 0, $e);
        }
    }
