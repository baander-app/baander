...
class SingleGaussian extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create SingleGaussian algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing SingleGaussian: " . $e->getMessage(), 0, $e);
        }
    }
