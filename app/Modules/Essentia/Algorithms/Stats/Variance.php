...
Outputs:
  ...
  [real] variance - the variance of the input array
 ...
 * Mode: standard
 */
class Variance extends BaseAlgorithm
{
    protected string $algorithmName = 'Variance';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute Variance: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Variance algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Variance: " . $e->getMessage(), 0, $e);
        }
    }
