...
class PoolAggregator extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create PoolAggregator algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing PoolAggregator: " . $e->getMessage(), 0, $e);
        }
    }
