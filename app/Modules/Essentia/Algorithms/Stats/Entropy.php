...
Outputs:
  ...
  [real] entropy - the entropy of the input array


Description:

  This algorithm computes the Shannon entropy of an array. Entropy can be used
 ...
 * Mode: standard
 */
class Entropy extends BaseAlgorithm
{
    protected string $algorithmName = 'Entropy';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute Entropy: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Entropy algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Entropy: " . $e->getMessage(), 0, $e);
        }
    }
