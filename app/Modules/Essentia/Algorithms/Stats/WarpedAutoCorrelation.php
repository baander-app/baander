...
class WarpedAutoCorrelation extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create WarpedAutoCorrelation algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing WarpedAutoCorrelation: " . $e->getMessage(), 0, $e);
        }
    }
