...
class GeometricMean extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create GeometricMean algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing GeometricMean: " . $e->getMessage(), 0, $e);
        }
    }
