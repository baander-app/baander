...
class DistributionShape extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create DistributionShape algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing DistributionShape: " . $e->getMessage(), 0, $e);
        }
    }
