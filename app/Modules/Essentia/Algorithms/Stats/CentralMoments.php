...
class CentralMoments extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create CentralMoments algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing CentralMoments: " . $e->getMessage(), 0, $e);
        }
    }
