...
Outputs:
  ...
  [real] mean - the mean of the input array
 ...
 * Mode: standard
 */
class Mean extends BaseAlgorithm
{
    protected string $algorithmName = 'Mean';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute Mean: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Mean algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Mean: " . $e->getMessage(), 0, $e);
        }
    }
