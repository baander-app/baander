...
Description:
  ...
  This algorithm implements a 2nd order IIR band-reject filter. Because of its
 ...
 * Mode: standard
 */
class BandReject extends BaseAlgorithm
{
    protected string $algorithmName = 'BandReject';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute BandReject: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create BandReject algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing BandReject: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['bandwidth', 'cutoffFrequency', 'sampleRate'];
    }
}