 ...
 * Mode: standard
 */
class AllPass extends BaseAlgorithm
{
    protected string $algorithmName = 'AllPass';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute AllPass: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create AllPass algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing AllPass: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['bandwidth', 'cutoffFrequency', 'sampleRate', 'order'];
    }
}