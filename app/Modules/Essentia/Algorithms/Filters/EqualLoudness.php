...
class EqualLoudness extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create EqualLoudness algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing EqualLoudness: " . $e->getMessage(), 0, $e);
        }
    }
