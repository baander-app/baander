...
class MovingAverage extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create MovingAverage algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing MovingAverage: " . $e->getMessage(), 0, $e);
        }
    }
