...
Outputs:
  ...
  [vector_real] filteredArray - the median-filtered input array
...
Description:
  ...
  This algorithm computes the median filtered version of the input signal
  giving the kernel size as detailed in [1].
 ...
 * Mode: standard
 */
class MedianFilter extends BaseAlgorithm
{
    protected string $algorithmName = 'MedianFilter';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute MedianFilter: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create MedianFilter algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing MedianFilter: " . $e->getMessage(), 0, $e);
        }
    }
        ...
        switch ($this->category) {
            ...
            case 'Tonal':
                if (!is_array($input) && !($input instanceof AudioVector)) {
                    throw new AlgorithmException('Filters algorithms expect array or AudioVector input');
                }
                break;
