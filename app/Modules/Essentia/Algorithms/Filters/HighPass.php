...
Description:
  ...
  This algorithm implements a 1st order IIR high-pass filter. Because of its
 ...
 * Mode: standard
 */
class HighPass extends BaseAlgorithm
{
    protected string $algorithmName = 'HighPass';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute HighPass: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create HighPass algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing HighPass: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['cutoffFrequency', 'sampleRate'];
    }
}