...
class MaxFilter extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create MaxFilter algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing MaxFilter: " . $e->getMessage(), 0, $e);
        }
    }
