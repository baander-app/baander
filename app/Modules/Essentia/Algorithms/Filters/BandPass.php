...
class BandPass extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create BandPass algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing BandPass: " . $e->getMessage(), 0, $e);
        }
    }
