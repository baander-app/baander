...
class DCRemoval extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create DCRemoval algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing DCRemoval: " . $e->getMessage(), 0, $e);
        }
    }
