...
class OverlapAdd extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create OverlapAdd algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing OverlapAdd: " . $e->getMessage(), 0, $e);
        }
    }
