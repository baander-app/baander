...
Inputs:
  ...
  [vector_real] signal - the input audio frame


Outputs:

  [vector_real] signal - the output audio samples
...
Description:
  ...
  This algorithm converts a sequence of input audio signal frames into a
 ...
 * Mode: standard
 */
class FrameToReal extends BaseAlgorithm
{
    protected string $algorithmName = 'FrameToReal';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute FrameToReal: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create FrameToReal algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing FrameToReal: " . $e->getMessage(), 0, $e);
        }
    }
