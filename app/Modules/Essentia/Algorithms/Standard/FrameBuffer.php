...
class FrameBuffer extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create FrameBuffer algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing FrameBuffer: " . $e->getMessage(), 0, $e);
        }
    }
