...
class PercivalEvaluatePulseTrains extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create PercivalEvaluatePulseTrains algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing PercivalEvaluatePulseTrains: " . $e->getMessage(), 0, $e);
        }
    }
