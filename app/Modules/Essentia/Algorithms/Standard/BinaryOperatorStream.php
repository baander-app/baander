...
class BinaryOperatorStream extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create BinaryOperatorStream algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing BinaryOperatorStream: " . $e->getMessage(), 0, $e);
        }
    }
