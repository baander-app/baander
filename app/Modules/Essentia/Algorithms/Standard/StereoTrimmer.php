...
Inputs:
  ...
  [vector_stereosample] signal - the input stereo signal


Outputs:

  [vector_stereosample] signal - the trimmed stereo signal
...
Description:
  ...
  This algorithm extracts a segment of a stereo audio signal given its start
  and end times.
 ...
 * Mode: standard
 */
class StereoTrimmer extends BaseAlgorithm
{
    protected string $algorithmName = 'StereoTrimmer';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute StereoTrimmer: " . $e->getMessage(),
                0,
                $e
            );
        }
