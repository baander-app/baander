...
class StereoTrimmer extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create StereoTrimmer algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing StereoTrimmer: " . $e->getMessage(), 0, $e);
        }
    }
