...
Outputs:
  ...
  [vector_real] signal - the output audio signal
...
Description:
  ...
  This algorithm scales the audio by the specified factor using clipping if
  required.
 * 
 * Category: Standard
 * Mode: standard
 */
class Scale extends BaseAlgorithm
{
    protected string $algorithmName = 'Scale';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute Scale: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Scale algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Scale: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['factor', 'maxAbsValue', 'clipping'];
    }
}