...
Description:
  ...
  This algorithm outputs a stereo signal given left and right channel
  separately.
 * 
 * Category: Standard
 * Mode: standard
 */
class StereoMuxer extends BaseAlgorithm
{
    protected string $algorithmName = 'StereoMuxer';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute StereoMuxer: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create StereoMuxer algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing StereoMuxer: " . $e->getMessage(), 0, $e);
        }
    }
