...
Outputs:
  ...
  [vector_real] left - the left channel of the audio signal
  [vector_real] right - the right channel of the audio signal


Description:

  This algorithm outputs left and right channel separately given a stereo
  signal. If the signal is monophonic, it outputs a zero signal on the right
  channel.
 * 
 * Category: Standard
 * Mode: standard
 */
class StereoDemuxer extends BaseAlgorithm
{
    protected string $algorithmName = 'StereoDemuxer';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute StereoDemuxer: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create StereoDemuxer algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing StereoDemuxer: " . $e->getMessage(), 0, $e);
        }
    }
