...
Inputs:
  ...
  [vector_real] spectrum - the input spectrum (must have more than 1 element)


Outputs:

  [real] maxMagFreq - the frequency with the largest magnitude [Hz]
...
Description:
  ...
  This algorithm computes the frequency with the largest magnitude in a
  spectrum.
  Note that a spectrum must contain at least two elements otherwise an
  exception is thrown
 * 
 * Category: Standard
 * Mode: standard
 */
class MaxMagFreq extends BaseAlgorithm
{
    protected string $algorithmName = 'MaxMagFreq';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute MaxMagFreq: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create MaxMagFreq algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing MaxMagFreq: " . $e->getMessage(), 0, $e);
        }
    }
