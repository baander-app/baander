...
class FrameCutter extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create FrameCutter algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing FrameCutter: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['frameSize', 'hopSize', 'silentFrames', 'startFromZero', 'validFrameThresholdRatio'];
    }
}