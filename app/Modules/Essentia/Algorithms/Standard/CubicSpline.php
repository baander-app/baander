...
class CubicSpline extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create CubicSpline algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing CubicSpline: " . $e->getMessage(), 0, $e);
        }
    }
