 ...
 * Mode: standard
 */
class BinaryOperator extends BaseAlgorithm
{
    protected string $algorithmName = 'BinaryOperator';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute BinaryOperator: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create BinaryOperator algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing BinaryOperator: " . $e->getMessage(), 0, $e);
        }
    }
