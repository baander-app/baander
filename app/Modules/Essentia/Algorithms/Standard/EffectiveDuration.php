...
class EffectiveDuration extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create EffectiveDuration algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing EffectiveDuration: " . $e->getMessage(), 0, $e);
        }
    }
