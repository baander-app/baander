...
Outputs:
  ...
  [real] duration - the duration of the signal [s]
 ...
 * Mode: standard
 */
class Duration extends BaseAlgorithm
{
    protected string $algorithmName = 'Duration';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute Duration: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Duration algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Duration: " . $e->getMessage(), 0, $e);
        }
    }
