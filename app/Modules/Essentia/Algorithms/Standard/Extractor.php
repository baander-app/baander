...
Description:
  ...
  This algorithm extracts all low-level, mid-level and high-level features from
  an audio signal and stores them in a pool.
 * 
 * Category: Standard
 * Mode: standard
 */
class Extractor extends BaseAlgorithm
{
    protected string $algorithmName = 'Extractor';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute Extractor: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Extractor algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Extractor: " . $e->getMessage(), 0, $e);
        }
    }
