...
class UnaryOperatorStream extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create UnaryOperatorStream algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing UnaryOperatorStream: " . $e->getMessage(), 0, $e);
        }
    }
