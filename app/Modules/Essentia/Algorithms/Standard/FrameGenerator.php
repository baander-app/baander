 ...
 * Mode: standard
 */
class FrameGenerator extends BaseAlgorithm
{
    protected string $algorithmName = 'FrameGenerator';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute FrameGenerator: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create FrameGenerator algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing FrameGenerator: " . $e->getMessage(), 0, $e);
        }
    }
