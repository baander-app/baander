...
class Windowing extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Windowing algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Windowing: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['type', 'size', 'zeroPadding', 'zeroPhase', 'normalized'];
    }
}