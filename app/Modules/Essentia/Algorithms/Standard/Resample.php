...
class Resample extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Resample algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Resample: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['inputSampleRate', 'outputSampleRate', 'quality'];
    }
}