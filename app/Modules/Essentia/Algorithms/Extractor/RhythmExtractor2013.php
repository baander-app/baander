...
class RhythmExtractor2013 extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create RhythmExtractor2013 algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing RhythmExtractor2013: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['method', 'minTempo', 'maxTempo'];
    }
}