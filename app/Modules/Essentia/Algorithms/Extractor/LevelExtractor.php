...
Outputs:
  ...
  [vector_real] loudness - the loudness values
...
Description:
  ...
  This algorithm extracts the loudness of an audio signal in frames using
  Loudness algorithm.
 * 
 * Category: Extractor
 * Mode: standard
 */
class LevelExtractor extends BaseAlgorithm
{
    protected string $algorithmName = 'LevelExtractor';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute LevelExtractor: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create LevelExtractor algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing LevelExtractor: " . $e->getMessage(), 0, $e);
        }
    }
