...
class LowLevelSpectralEqloudExtractor extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create LowLevelSpectralEqloudExtractor algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing LowLevelSpectralEqloudExtractor: " . $e->getMessage(), 0, $e);
        }
    }
