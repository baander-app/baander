...
class KeyExtractor extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create KeyExtractor algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing KeyExtractor: " . $e->getMessage(), 0, $e);
        }
    }
