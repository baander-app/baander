...
class LowLevelSpectralExtractor extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create LowLevelSpectralExtractor algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing LowLevelSpectralExtractor: " . $e->getMessage(), 0, $e);
        }
    }
