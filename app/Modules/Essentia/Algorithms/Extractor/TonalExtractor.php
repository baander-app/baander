...
class TonalExtractor extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create TonalExtractor algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing TonalExtractor: " . $e->getMessage(), 0, $e);
        }
    }
