...
Description:
  ...
  This algorithm is a wrapper for Freesound Extractor. See documentation for
  'essentia_streaming_extractor_freesound'.
 * 
 * Category: Extractor
 * Mode: standard
 */
class FreesoundExtractor extends BaseAlgorithm
{
    protected string $algorithmName = 'FreesoundExtractor';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute FreesoundExtractor: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create FreesoundExtractor algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing FreesoundExtractor: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['frameSize', 'hopSize', 'sampleRate'];
    }
}