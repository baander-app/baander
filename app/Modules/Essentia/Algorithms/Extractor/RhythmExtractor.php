...
class RhythmExtractor extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create RhythmExtractor algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing RhythmExtractor: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['method', 'minTempo', 'maxTempo', 'frameHop'];
    }
}