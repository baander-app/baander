...
class HighResolutionFeatures extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create HighResolutionFeatures algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing HighResolutionFeatures: " . $e->getMessage(), 0, $e);
        }
    }
