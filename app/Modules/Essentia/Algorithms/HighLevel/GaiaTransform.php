...
class GaiaTransform extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create GaiaTransform algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing GaiaTransform: " . $e->getMessage(), 0, $e);
        }
    }
