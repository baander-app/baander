...
class Danceability extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Danceability algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Danceability: " . $e->getMessage(), 0, $e);
        }
    }
