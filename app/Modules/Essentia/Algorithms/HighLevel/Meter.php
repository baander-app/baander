...
Outputs:
  ...
  [real] meter - the time signature


Description:

  This algorithm estimates the time signature of a given beatogram by finding
  the highest correlation between beats.
 ...
 * Mode: standard
 */
class Meter extends BaseAlgorithm
{
    protected string $algorithmName = 'Meter';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute Meter: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Meter algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Meter: " . $e->getMessage(), 0, $e);
        }
    }
