...
class CoverSongSimilarity extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create CoverSongSimilarity algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing CoverSongSimilarity: " . $e->getMessage(), 0, $e);
        }
    }
