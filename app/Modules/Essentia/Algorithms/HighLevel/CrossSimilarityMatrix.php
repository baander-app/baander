...
class CrossSimilarityMatrix extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create CrossSimilarityMatrix algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing CrossSimilarityMatrix: " . $e->getMessage(), 0, $e);
        }
    }
