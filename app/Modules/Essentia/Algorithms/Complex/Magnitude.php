...
class Magnitude extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Magnitude algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Magnitude: " . $e->getMessage(), 0, $e);
        }
    }
