...
class PolarToCartesian extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create PolarToCartesian algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing PolarToCartesian: " . $e->getMessage(), 0, $e);
        }
    }
        ...
        switch ($this->category) {
            ...
            case 'Tonal':
                if (!is_array($input) && !($input instanceof AudioVector)) {
                    throw new AlgorithmException('Complex algorithms expect array or AudioVector input');
                }
                break;
