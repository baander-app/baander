...
class CartesianToPolar extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create CartesianToPolar algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing CartesianToPolar: " . $e->getMessage(), 0, $e);
        }
    }
