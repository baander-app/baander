...
class MonoMixer extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create MonoMixer algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing MonoMixer: " . $e->getMessage(), 0, $e);
        }
    }
