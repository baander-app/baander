...
class AudioLoader extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create AudioLoader algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing AudioLoader: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['filename', 'computeMD5', 'sampleRate'];
    }
}