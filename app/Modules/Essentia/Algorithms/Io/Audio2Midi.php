...
class Audio2Midi extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Audio2Midi algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Audio2Midi: " . $e->getMessage(), 0, $e);
        }
    }
