...
class YamlOutput extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create YamlOutput algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing YamlOutput: " . $e->getMessage(), 0, $e);
        }
    }
