...
class AudioOnsetsMarker extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create AudioOnsetsMarker algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing AudioOnsetsMarker: " . $e->getMessage(), 0, $e);
        }
    }
