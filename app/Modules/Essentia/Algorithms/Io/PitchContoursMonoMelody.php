...
Description:
  ...
  This algorithm converts a set of pitch contours into a sequence of f0 values
  in Hz by taking the value of the most salient contour in each frame.
 ...
 * Mode: standard
 */
class PitchContoursMonoMelody extends BaseAlgorithm
{
    protected string $algorithmName = 'PitchContoursMonoMelody';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute PitchContoursMonoMelody: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create PitchContoursMonoMelody algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing PitchContoursMonoMelody: " . $e->getMessage(), 0, $e);
        }
    }
