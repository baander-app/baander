...
class EasyLoader extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create EasyLoader algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing EasyLoader: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['filename', 'sampleRate', 'startTime', 'endTime'];
    }
}