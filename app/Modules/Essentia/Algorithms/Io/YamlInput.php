...
class YamlInput extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create YamlInput algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing YamlInput: " . $e->getMessage(), 0, $e);
        }
    }
