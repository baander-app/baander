...
Parameters:
  ...
  replayGain:
    ...
    the value of the replayGain [dB] that should be used to normalize the
    signal [dB]

  sampleRate:
    real ∈ {32000,44100,48000} (default = 44100)
...
Description:
  ...
  mono and normalizes using replayGain and equal-loudness filter. Audio is
  resampled in case the given sampling rate does not match the sampling rate of
  the input signal and normalized by the given replayGain gain. In addition,
  audio data is filtered through an equal-loudness filter.
  
  This algorithm uses MonoLoader and thus inherits all of its input
 ...
 * Mode: standard
 */
class EqloudLoader extends BaseAlgorithm
{
    protected string $algorithmName = 'EqloudLoader';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute EqloudLoader: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create EqloudLoader algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing EqloudLoader: " . $e->getMessage(), 0, $e);
        }
    }
