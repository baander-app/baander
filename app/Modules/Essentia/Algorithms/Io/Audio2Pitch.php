...
class Audio2Pitch extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Audio2Pitch algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Audio2Pitch: " . $e->getMessage(), 0, $e);
        }
    }
