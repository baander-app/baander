...
class MonoWriter extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create MonoWriter algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing MonoWriter: " . $e->getMessage(), 0, $e);
        }
    }
