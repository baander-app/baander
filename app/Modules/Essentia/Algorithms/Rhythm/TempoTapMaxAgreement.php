...
class TempoTapMaxAgreement extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create TempoTapMaxAgreement algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing TempoTapMaxAgreement: " . $e->getMessage(), 0, $e);
        }
    }
