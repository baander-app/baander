...
class Onsets extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Onsets algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Onsets: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['alpha', 'delay', 'frameRate', 'maxTempo', 'minTempo', 'silenceThreshold'];
    }
}