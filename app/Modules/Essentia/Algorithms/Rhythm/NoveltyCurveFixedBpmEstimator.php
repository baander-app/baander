...
class NoveltyCurveFixedBpmEstimator extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create NoveltyCurveFixedBpmEstimator algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing NoveltyCurveFixedBpmEstimator: " . $e->getMessage(), 0, $e);
        }
    }
