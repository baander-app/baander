...
class RhythmDescriptors extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create RhythmDescriptors algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing RhythmDescriptors: " . $e->getMessage(), 0, $e);
        }
    }
