...
class HarmonicBpm extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create HarmonicBpm algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing HarmonicBpm: " . $e->getMessage(), 0, $e);
        }
    }
