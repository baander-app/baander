...
class LoopBpmEstimator extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create LoopBpmEstimator algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing LoopBpmEstimator: " . $e->getMessage(), 0, $e);
        }
    }
