...
class Beatogram extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Beatogram algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Beatogram: " . $e->getMessage(), 0, $e);
        }
    }
