...
class BeatTrackerDegara extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create BeatTrackerDegara algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing BeatTrackerDegara: " . $e->getMessage(), 0, $e);
        }
    }
