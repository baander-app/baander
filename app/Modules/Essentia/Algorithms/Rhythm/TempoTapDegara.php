...
class TempoTapDegara extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create TempoTapDegara algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing TempoTapDegara: " . $e->getMessage(), 0, $e);
        }
    }
