...
class OnsetDetectionGlobal extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create OnsetDetectionGlobal algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing OnsetDetectionGlobal: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['method', 'sampleRate', 'frameSize', 'hopSize'];
    }
}