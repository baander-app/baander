...
class BpmRubato extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create BpmRubato algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing BpmRubato: " . $e->getMessage(), 0, $e);
        }
    }
