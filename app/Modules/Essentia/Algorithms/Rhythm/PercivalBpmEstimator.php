...
class PercivalBpmEstimator extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create PercivalBpmEstimator algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing PercivalBpmEstimator: " . $e->getMessage(), 0, $e);
        }
    }
