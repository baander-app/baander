...
class NoveltyCurve extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create NoveltyCurve algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing NoveltyCurve: " . $e->getMessage(), 0, $e);
        }
    }
