...
class RhythmTransform extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create RhythmTransform algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing RhythmTransform: " . $e->getMessage(), 0, $e);
        }
    }
