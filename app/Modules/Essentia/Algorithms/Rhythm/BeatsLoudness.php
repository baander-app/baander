...
class BeatsLoudness extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create BeatsLoudness algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing BeatsLoudness: " . $e->getMessage(), 0, $e);
        }
    }
