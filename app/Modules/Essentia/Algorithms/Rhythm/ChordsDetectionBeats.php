...
class ChordsDetectionBeats extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create ChordsDetectionBeats algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing ChordsDetectionBeats: " . $e->getMessage(), 0, $e);
        }
    }
