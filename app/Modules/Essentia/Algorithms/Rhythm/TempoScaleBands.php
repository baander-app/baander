...
class TempoScaleBands extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create TempoScaleBands algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing TempoScaleBands: " . $e->getMessage(), 0, $e);
        }
    }
