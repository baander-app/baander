...
class TempoTapTicks extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create TempoTapTicks algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing TempoTapTicks: " . $e->getMessage(), 0, $e);
        }
    }
