...
class LoopBpmConfidence extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create LoopBpmConfidence algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing LoopBpmConfidence: " . $e->getMessage(), 0, $e);
        }
    }
