...
class BpmHistogramDescriptors extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create BpmHistogramDescriptors algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing BpmHistogramDescriptors: " . $e->getMessage(), 0, $e);
        }
    }
