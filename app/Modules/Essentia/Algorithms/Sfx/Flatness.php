...
Outputs:
  ...
  [real] flatness - the flatness (ratio between the geometric and the arithmetic mean of the input array)
...
Description:
  ...
  Flatness is undefined for empty input and negative values, therefore an
 ...
 * Mode: standard
 */
class Flatness extends BaseAlgorithm
{
    protected string $algorithmName = 'Flatness';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute Flatness: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Flatness algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Flatness: " . $e->getMessage(), 0, $e);
        }
    }
