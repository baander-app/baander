...
class LogAttackTime extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create LogAttackTime algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing LogAttackTime: " . $e->getMessage(), 0, $e);
        }
    }
