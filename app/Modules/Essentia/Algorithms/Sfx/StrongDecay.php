...
class StrongDecay extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create StrongDecay algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing StrongDecay: " . $e->getMessage(), 0, $e);
        }
    }
