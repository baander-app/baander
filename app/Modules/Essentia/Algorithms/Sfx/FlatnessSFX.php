...
class FlatnessSFX extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create FlatnessSFX algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing FlatnessSFX: " . $e->getMessage(), 0, $e);
        }
    }
