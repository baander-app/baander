...
Outputs:
  ...
  [vector_real] signal - the derivative of the input signal


Description:

  This algorithm returns the first-order derivative of an input signal. That
  is, for each input value it returns the value minus the previous one.
 * 
 * Category: Sfx
 * Mode: standard
 */
class Derivative extends BaseAlgorithm
{
    protected string $algorithmName = 'Derivative';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute Derivative: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Derivative algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Derivative: " . $e->getMessage(), 0, $e);
        }
    }
