...
Outputs:
  ...
  [real] minToTotal - the minimum amplitude position to total length ratio


Description:

  This algorithm computes the ratio between the index of the minimum value of
  the envelope of a signal and the total length of the envelope.
 ...
 * Mode: standard
 */
class MinToTotal extends BaseAlgorithm
{
    protected string $algorithmName = 'MinToTotal';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute MinToTotal: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create MinToTotal algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing MinToTotal: " . $e->getMessage(), 0, $e);
        }
    }
