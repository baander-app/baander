...
class StrongPeak extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create StrongPeak algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing StrongPeak: " . $e->getMessage(), 0, $e);
        }
    }
