...
class Decrease extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Decrease algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Decrease: " . $e->getMessage(), 0, $e);
        }
    }
