...
class AfterMaxToBeforeMaxEnergyRatio extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create AfterMaxToBeforeMaxEnergyRatio algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing AfterMaxToBeforeMaxEnergyRatio: " . $e->getMessage(), 0, $e);
        }
    }
