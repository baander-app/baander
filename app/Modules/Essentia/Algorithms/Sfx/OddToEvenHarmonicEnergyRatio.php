...
class OddToEvenHarmonicEnergyRatio extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create OddToEvenHarmonicEnergyRatio algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing OddToEvenHarmonicEnergyRatio: " . $e->getMessage(), 0, $e);
        }
    }
