...
class FlatnessDB extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create FlatnessDB algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing FlatnessDB: " . $e->getMessage(), 0, $e);
        }
    }
