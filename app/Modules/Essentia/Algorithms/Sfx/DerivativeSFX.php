...
class DerivativeSFX extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create DerivativeSFX algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing DerivativeSFX: " . $e->getMessage(), 0, $e);
        }
    }
