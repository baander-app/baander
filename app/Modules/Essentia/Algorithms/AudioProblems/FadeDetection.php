...
class FadeDetection extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create FadeDetection algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing FadeDetection: " . $e->getMessage(), 0, $e);
        }
    }
