...
class FalseStereoDetector extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create FalseStereoDetector algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing FalseStereoDetector: " . $e->getMessage(), 0, $e);
        }
    }
