...
class StartStopCut extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create StartStopCut algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing StartStopCut: " . $e->getMessage(), 0, $e);
        }
    }
