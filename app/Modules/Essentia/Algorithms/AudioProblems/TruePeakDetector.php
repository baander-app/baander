...
class TruePeakDetector extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create TruePeakDetector algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing TruePeakDetector: " . $e->getMessage(), 0, $e);
        }
    }
