...
class DiscontinuityDetector extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create DiscontinuityDetector algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing DiscontinuityDetector: " . $e->getMessage(), 0, $e);
        }
    }
