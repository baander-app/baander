...
class GapsDetector extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create GapsDetector algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing GapsDetector: " . $e->getMessage(), 0, $e);
        }
    }
