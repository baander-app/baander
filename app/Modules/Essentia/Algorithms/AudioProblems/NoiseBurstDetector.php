...
class NoiseBurstDetector extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create NoiseBurstDetector algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing NoiseBurstDetector: " . $e->getMessage(), 0, $e);
        }
    }
