...
class NoiseAdder extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create NoiseAdder algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing NoiseAdder: " . $e->getMessage(), 0, $e);
        }
    }
