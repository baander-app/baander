...
class SilenceRate extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create SilenceRate algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing SilenceRate: " . $e->getMessage(), 0, $e);
        }
    }
