...
Inputs:
  ...
  [vector_real] input - input array


Outputs:

  [vector_real] output - output resample array
...
Description:
  ...
  This algorithm resamples a sequence using FFT/IFFT. The input and output
  sizes must be an even number. The algorithm is a counterpart of the resample
  function in SciPy.
 * 
 * Category: Spectral
 * Mode: standard
 */
class ResampleFFT extends BaseAlgorithm
{
    protected string $algorithmName = 'ResampleFFT';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute ResampleFFT: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create ResampleFFT algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing ResampleFFT: " . $e->getMessage(), 0, $e);
        }
    }
