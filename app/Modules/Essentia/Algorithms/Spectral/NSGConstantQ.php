...
Outputs:
  ...
  [vector_vector_complex] constantq - the constant Q transform of the input frame
         [vector_complex] constantqdc - the DC band transform of the input frame. Only needed for the inverse transform
         [vector_complex] constantqnf - the Nyquist band transform of the input frame. Only needed for the inverse transform
...
Description:
  ...
  This algorithm computes a constant Q transform using non stationary Gabor
  frames and returns a complex time-frequency representation of the input
  vector.
 ...
 * Mode: standard
 */
class NSGConstantQ extends BaseAlgorithm
{
    protected string $algorithmName = 'NSGConstantQ';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute NSGConstantQ: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create NSGConstantQ algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing NSGConstantQ: " . $e->getMessage(), 0, $e);
        }
    }
