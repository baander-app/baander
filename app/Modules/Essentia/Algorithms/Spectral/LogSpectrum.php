...
class LogSpectrum extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create LogSpectrum algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing LogSpectrum: " . $e->getMessage(), 0, $e);
        }
    }
