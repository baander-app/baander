...
class TriangularBarkBands extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create TriangularBarkBands algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing TriangularBarkBands: " . $e->getMessage(), 0, $e);
        }
    }
