...
class MultiPitchMelodia extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create MultiPitchMelodia algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing MultiPitchMelodia: " . $e->getMessage(), 0, $e);
        }
    }
