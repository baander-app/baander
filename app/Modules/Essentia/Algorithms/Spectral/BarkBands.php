...
class BarkBands extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create BarkBands algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing BarkBands: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['sampleRate', 'inputSize', 'numberBands', 'normalize'];
    }
}