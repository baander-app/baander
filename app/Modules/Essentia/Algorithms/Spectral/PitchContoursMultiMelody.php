...
class PitchContoursMultiMelody extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create PitchContoursMultiMelody algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing PitchContoursMultiMelody: " . $e->getMessage(), 0, $e);
        }
    }
