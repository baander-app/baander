...
class SpectralComplexity extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create SpectralComplexity algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing SpectralComplexity: " . $e->getMessage(), 0, $e);
        }
    }
