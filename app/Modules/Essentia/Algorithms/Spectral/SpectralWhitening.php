...
class SpectralWhitening extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create SpectralWhitening algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing SpectralWhitening: " . $e->getMessage(), 0, $e);
        }
    }
