...
class PitchYinFFT extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create PitchYinFFT algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing PitchYinFFT: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['frameSize', 'sampleRate', 'tolerance', 'interpolate', 'minFrequency', 'maxFrequency'];
    }
}