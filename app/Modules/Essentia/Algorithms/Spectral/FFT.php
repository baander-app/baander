...
Description:
  ...
  This algorithm computes the positive complex short-term Fourier transform
  (STFT) of an array using the FFT algorithm. The resulting fft has a size of
  (s/2)+1, where s is the size of the input frame.
 ...
 * Mode: standard
 */
class FFT extends BaseAlgorithm
{
    protected string $algorithmName = 'FFT';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute FFT: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create FFT algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing FFT: " . $e->getMessage(), 0, $e);
        }
    }
