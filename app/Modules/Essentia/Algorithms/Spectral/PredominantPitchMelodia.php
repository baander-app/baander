...
class PredominantPitchMelodia extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create PredominantPitchMelodia algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing PredominantPitchMelodia: " . $e->getMessage(), 0, $e);
        }
    }
