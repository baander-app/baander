...
class SuperFluxPeaks extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create SuperFluxPeaks algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing SuperFluxPeaks: " . $e->getMessage(), 0, $e);
        }
    }
