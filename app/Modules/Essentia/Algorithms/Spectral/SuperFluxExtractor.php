...
class SuperFluxExtractor extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create SuperFluxExtractor algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing SuperFluxExtractor: " . $e->getMessage(), 0, $e);
        }
    }
