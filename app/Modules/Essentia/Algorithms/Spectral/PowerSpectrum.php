...
Outputs:
  ...
  [vector_real] powerSpectrum - power spectrum of the input signal
...
Description:
  ...
  This algorithm computes the power spectrum of an array of Reals. The
  resulting power spectrum has a size which is half the size of the input array
  plus one. Bins contain squared magnitude values.
 ...
 * Mode: standard
 */
class PowerSpectrum extends BaseAlgorithm
{
    protected string $algorithmName = 'PowerSpectrum';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute PowerSpectrum: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create PowerSpectrum algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing PowerSpectrum: " . $e->getMessage(), 0, $e);
        }
    }
