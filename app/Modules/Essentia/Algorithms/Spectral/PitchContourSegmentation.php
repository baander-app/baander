...
class PitchContourSegmentation extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create PitchContourSegmentation algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing PitchContourSegmentation: " . $e->getMessage(), 0, $e);
        }
    }
