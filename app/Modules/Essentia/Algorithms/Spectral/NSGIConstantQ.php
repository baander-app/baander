...
class NSGIConstantQ extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create NSGIConstantQ algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing NSGIConstantQ: " . $e->getMessage(), 0, $e);
        }
    }
