...
Outputs:
  ...
  [vector_real] spectrumCQ - the magnitude constant-Q spectrum
...
Description:
  ...
  This algorithm computes the magnitude of the Constant-Q spectrum. See
  ConstantQ algorithm for more details.
 * 
 * Category: Spectral
 * Mode: standard
 */
class SpectrumCQ extends BaseAlgorithm
{
    protected string $algorithmName = 'SpectrumCQ';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute SpectrumCQ: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create SpectrumCQ algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing SpectrumCQ: " . $e->getMessage(), 0, $e);
        }
    }
