...
class PitchContours extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create PitchContours algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing PitchContours: " . $e->getMessage(), 0, $e);
        }
    }
