...
class PitchContoursMelody extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create PitchContoursMelody algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing PitchContoursMelody: " . $e->getMessage(), 0, $e);
        }
    }
