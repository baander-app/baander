...
class SpectrumToCent extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create SpectrumToCent algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing SpectrumToCent: " . $e->getMessage(), 0, $e);
        }
    }
