...
class ConstantQ extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create ConstantQ algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing ConstantQ: " . $e->getMessage(), 0, $e);
        }
    }
