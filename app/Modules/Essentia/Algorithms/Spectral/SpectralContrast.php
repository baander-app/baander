...
class SpectralContrast extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create SpectralContrast algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing SpectralContrast: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['sampleRate', 'frameSize', 'numberBands', 'lowFrequencyBound', 'highFrequencyBound', 'neighbourRatio', 'staticDistribution'];
    }
}