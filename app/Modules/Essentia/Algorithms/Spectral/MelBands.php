...
class MelBands extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create MelBands algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing MelBands: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['sampleRate', 'inputSize', 'numberBands', 'lowFrequencyBound', 'highFrequencyBound', 'warpingFormula', 'weighting', 'normalize', 'type', 'log'];
    }
}