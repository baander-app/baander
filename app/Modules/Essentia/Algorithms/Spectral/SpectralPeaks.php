...
class SpectralPeaks extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create SpectralPeaks algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing SpectralPeaks: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['sampleRate', 'threshold', 'minFrequency', 'maxFrequency', 'maxPeaks', 'interpolate', 'magnitudeThreshold', 'orderBy'];
    }
}