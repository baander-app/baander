...
Outputs:
  ...
  [vector_real] spectrum - magnitude spectrum of the input audio signal
...
Description:
  ...
  This algorithm computes the magnitude spectrum of an array of Reals. The
  resulting magnitude spectrum has a size which is half the size of the input
  array plus one. Bins contain raw (linear) magnitude values.
 ...
 * Mode: standard
 */
class Spectrum extends BaseAlgorithm
{
    protected string $algorithmName = 'Spectrum';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute Spectrum: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Spectrum algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Spectrum: " . $e->getMessage(), 0, $e);
        }
    }
