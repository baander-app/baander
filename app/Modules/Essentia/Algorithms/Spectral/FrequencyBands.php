...
class FrequencyBands extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create FrequencyBands algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing FrequencyBands: " . $e->getMessage(), 0, $e);
        }
    }
