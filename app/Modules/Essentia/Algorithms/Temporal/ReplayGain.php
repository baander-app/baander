...
class ReplayGain extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create ReplayGain algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing ReplayGain: " . $e->getMessage(), 0, $e);
        }
    }
