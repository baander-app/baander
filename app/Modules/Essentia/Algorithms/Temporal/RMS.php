...
Outputs:
  ...
  [real] rms - the root mean square of the input array


Description:

  This algorithm computes the root mean square (quadratic mean) of an array.
  RMS is not defined for empty arrays. In such case, an exception will be
  thrown
  .
  References:
 ...
 * Mode: standard
 */
class RMS extends BaseAlgorithm
{
    protected string $algorithmName = 'RMS';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute RMS: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create RMS algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing RMS: " . $e->getMessage(), 0, $e);
        }
    }
