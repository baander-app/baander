...
class DynamicComplexity extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create DynamicComplexity algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing DynamicComplexity: " . $e->getMessage(), 0, $e);
        }
    }
