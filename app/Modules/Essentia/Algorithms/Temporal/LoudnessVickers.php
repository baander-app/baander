...
class LoudnessVickers extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create LoudnessVickers algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing LoudnessVickers: " . $e->getMessage(), 0, $e);
        }
    }
