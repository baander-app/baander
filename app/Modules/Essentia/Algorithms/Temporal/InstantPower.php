...
Outputs:
  ...
  [real] power - the instant power of the input array


Description:

  This algorithm computes the instant power of an array. That is, the energy of
  the array over its size.
 ...
 * Mode: standard
 */
class InstantPower extends BaseAlgorithm
{
    protected string $algorithmName = 'InstantPower';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute InstantPower: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create InstantPower algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing InstantPower: " . $e->getMessage(), 0, $e);
        }
    }
