...
class EnergyBand extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create EnergyBand algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing EnergyBand: " . $e->getMessage(), 0, $e);
        }
    }
