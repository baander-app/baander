 ...
 * Mode: standard
 */
class Energy extends BaseAlgorithm
{
    protected string $algorithmName = 'Energy';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute Energy: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Energy algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Energy: " . $e->getMessage(), 0, $e);
        }
    }
