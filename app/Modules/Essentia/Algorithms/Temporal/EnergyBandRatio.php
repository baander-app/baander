...
class EnergyBandRatio extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create EnergyBandRatio algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing EnergyBandRatio: " . $e->getMessage(), 0, $e);
        }
    }
