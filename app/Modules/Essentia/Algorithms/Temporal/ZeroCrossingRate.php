...
class ZeroCrossingRate extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create ZeroCrossingRate algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing ZeroCrossingRate: " . $e->getMessage(), 0, $e);
        }
    }
