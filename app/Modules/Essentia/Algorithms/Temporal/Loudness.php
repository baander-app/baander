...
class Loudness extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Loudness algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Loudness: " . $e->getMessage(), 0, $e);
        }
    }
