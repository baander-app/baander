...
class Envelope extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Envelope algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Envelope: " . $e->getMessage(), 0, $e);
        }
    }
