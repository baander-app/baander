...
class ChordsDetection extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create ChordsDetection algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing ChordsDetection: " . $e->getMessage(), 0, $e);
        }
    }
