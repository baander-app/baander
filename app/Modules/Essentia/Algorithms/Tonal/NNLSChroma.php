...
class NNLSChroma extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create NNLSChroma algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing NNLSChroma: " . $e->getMessage(), 0, $e);
        }
    }
