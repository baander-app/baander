...
class PitchFilter extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create PitchFilter algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing PitchFilter: " . $e->getMessage(), 0, $e);
        }
    }
