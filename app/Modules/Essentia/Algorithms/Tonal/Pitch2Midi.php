...
class Pitch2Midi extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Pitch2Midi algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Pitch2Midi: " . $e->getMessage(), 0, $e);
        }
    }
