...
class PitchYin extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create PitchYin algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing PitchYin: " . $e->getMessage(), 0, $e);
        }
    }
