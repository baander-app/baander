...
class PitchYinProbabilitiesHMM extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create PitchYinProbabilitiesHMM algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing PitchYinProbabilitiesHMM: " . $e->getMessage(), 0, $e);
        }
    }
