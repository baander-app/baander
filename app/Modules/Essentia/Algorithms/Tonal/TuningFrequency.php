...
class TuningFrequency extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create TuningFrequency algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing TuningFrequency: " . $e->getMessage(), 0, $e);
        }
    }
