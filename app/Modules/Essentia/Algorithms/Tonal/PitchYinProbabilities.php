...
class PitchYinProbabilities extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create PitchYinProbabilities algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing PitchYinProbabilities: " . $e->getMessage(), 0, $e);
        }
    }
