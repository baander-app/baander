...
class PercivalEnhanceHarmonics extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create PercivalEnhanceHarmonics algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing PercivalEnhanceHarmonics: " . $e->getMessage(), 0, $e);
        }
    }
