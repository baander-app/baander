...
class Chromagram extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Chromagram algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Chromagram: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['sampleRate', 'minFrequency', 'maxFrequency', 'referenceFrequency', 'binsPerOctave', 'normalizeType', 'threshold'];
    }
}