...
Outputs:
  ...
  [string] fingerprint - the chromaprint as a base64-encoded string
...
Parameters:
  ...
  maxLength:
    ...
    use the first 'maxLength' seconds to compute the chromaprint. 0 to use the
    full audio length [s]
...
Description:
  ...
  This algorithm computes the fingerprint of the input signal using Chromaprint
  algorithm. It is a wrapper of the Chromaprint library [1,2]. The chromaprints
 ...
 * Mode: standard
 */
class Chromaprinter extends BaseAlgorithm
{
    protected string $algorithmName = 'Chromaprinter';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute Chromaprinter: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Chromaprinter algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Chromaprinter: " . $e->getMessage(), 0, $e);
        }
    }
