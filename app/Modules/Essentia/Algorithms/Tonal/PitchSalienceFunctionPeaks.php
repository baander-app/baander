...
class PitchSalienceFunctionPeaks extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create PitchSalienceFunctionPeaks algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing PitchSalienceFunctionPeaks: " . $e->getMessage(), 0, $e);
        }
    }
