...
class HPCP extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create HPCP algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing HPCP: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['sampleRate', 'minFrequency', 'maxFrequency', 'referenceFrequency', 'nonLinear', 'normalized', 'size', 'windowSize', 'maxShifted', 'splitFrequency', 'harmonics', 'bandPreset', 'bandSplitFrequency', 'weightType'];
    }
}