...
class ChordsDescriptors extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create ChordsDescriptors algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing ChordsDescriptors: " . $e->getMessage(), 0, $e);
        }
    }
