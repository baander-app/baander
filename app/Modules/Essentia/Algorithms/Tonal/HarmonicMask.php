...
class HarmonicMask extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create HarmonicMask algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing HarmonicMask: " . $e->getMessage(), 0, $e);
        }
    }
