...
class HarmonicPeaks extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create HarmonicPeaks algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing HarmonicPeaks: " . $e->getMessage(), 0, $e);
        }
    }
