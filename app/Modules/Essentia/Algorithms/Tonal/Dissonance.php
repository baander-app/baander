...
class Dissonance extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create Dissonance algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing Dissonance: " . $e->getMessage(), 0, $e);
        }
    }
