...
class PitchYinProbabilistic extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create PitchYinProbabilistic algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing PitchYinProbabilistic: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['frameSize', 'sampleRate', 'tolerance', 'lowRMS', 'outputUnvoiced', 'preciseTime'];
    }
}