 ...
 * Mode: standard
 */
class HprModelAnal extends BaseAlgorithm
{
    protected string $algorithmName = 'HprModelAnal';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute HprModelAnal: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create HprModelAnal algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing HprModelAnal: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['sampleRate', 'maxnSines', 'magnitudeThreshold', 'minSineDur', 'nHarmonics', 'harmThreshold', 'freqDevOffset', 'freqDevSlope'];
    }
}