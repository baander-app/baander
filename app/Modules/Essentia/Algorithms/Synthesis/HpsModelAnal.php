 ...
 * Mode: standard
 */
class HpsModelAnal extends BaseAlgorithm
{
    protected string $algorithmName = 'HpsModelAnal';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute HpsModelAnal: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create HpsModelAnal algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing HpsModelAnal: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['sampleRate', 'maxnSines', 'magnitudeThreshold', 'minSineDur', 'nHarmonics', 'harmThreshold', 'freqDevOffset', 'freqDevSlope', 'stocf'];
    }
}