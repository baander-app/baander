 ...
 * Mode: standard
 */
class SpsModelAnal extends BaseAlgorithm
{
    protected string $algorithmName = 'SpsModelAnal';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute SpsModelAnal: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create SpsModelAnal algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing SpsModelAnal: " . $e->getMessage(), 0, $e);
        }
    }
