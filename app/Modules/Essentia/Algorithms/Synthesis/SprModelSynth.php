...
class SprModelSynth extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create SprModelSynth algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing SprModelSynth: " . $e->getMessage(), 0, $e);
        }
    }
