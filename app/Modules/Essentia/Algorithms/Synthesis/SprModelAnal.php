...
Outputs:
  ...
  [vector_real] res - output residual frame
...
Description:
  ...
  algorithm. This algorithm uses SineModelAnal. See documentation for possible
 ...
 * Mode: standard
 */
class SprModelAnal extends BaseAlgorithm
{
    protected string $algorithmName = 'SprModelAnal';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute SprModelAnal: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create SprModelAnal algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing SprModelAnal: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['sampleRate', 'maxnSines', 'magnitudeThreshold', 'minSineDur', 'freqDevOffset', 'freqDevSlope', 'stocf'];
    }
}