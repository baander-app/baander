...
Inputs:
  ...
  [vector_real] stocenv - the stochastic envelope input


Outputs:

  [vector_real] frame - the output frame
...
Description:
  ...
  This algorithm computes the stochastic model synthesis. It generates the
  noisy spectrum from a resampled spectral envelope of the stochastic
  component.
 ...
 * Mode: standard
 */
class StochasticModelSynth extends BaseAlgorithm
{
    protected string $algorithmName = 'StochasticModelSynth';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute StochasticModelSynth: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create StochasticModelSynth algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing StochasticModelSynth: " . $e->getMessage(), 0, $e);
        }
    }
