...
Outputs:
  ...
  [vector_complex] fft - the output FFT frame
 ...
 * Mode: standard
 */
class SineModelSynth extends BaseAlgorithm
{
    protected string $algorithmName = 'SineModelSynth';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute SineModelSynth: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create SineModelSynth algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing SineModelSynth: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['sampleRate', 'fftSize', 'hopSize'];
    }
}