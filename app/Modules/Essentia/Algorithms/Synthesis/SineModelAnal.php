...
class SineModelAnal extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create SineModelAnal algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing SineModelAnal: " . $e->getMessage(), 0, $e);
        }
    }
    ...
    private function getValidParameters(): array
    {
        ...
        return ['sampleRate', 'maxnSines', 'magnitudeThreshold', 'minSineDur', 'freqDevOffset', 'freqDevSlope'];
    }
}