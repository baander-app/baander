...
Outputs:
  ...
  [vector_real] stocframe - the output audio frame for stochastic component 
...
Description:
  ...
  This algorithm computes the sinusoidal plus stochastic model synthesis from
  SPS model analysis.
 * 
 * Category: Synthesis
 * Mode: standard
 */
class SpsModelSynth extends BaseAlgorithm
{
    protected string $algorithmName = 'SpsModelSynth';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute SpsModelSynth: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create SpsModelSynth algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing SpsModelSynth: " . $e->getMessage(), 0, $e);
        }
    }
