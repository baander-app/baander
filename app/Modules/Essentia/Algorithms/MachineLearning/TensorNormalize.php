...
class TensorNormalize extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create TensorNormalize algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing TensorNormalize: " . $e->getMessage(), 0, $e);
        }
    }
