...
class TensorflowInputMusiCNN extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create TensorflowInputMusiCNN algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing TensorflowInputMusiCNN: " . $e->getMessage(), 0, $e);
        }
    }
