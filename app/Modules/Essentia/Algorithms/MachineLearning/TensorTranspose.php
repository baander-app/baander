...
Outputs:
  ...
  [tensor_real] tensor - the transposed output tensor
...
Parameters:
  ...
  permutation:
    vector_integer
    permutation of [0,1,2,3]. The i'th dimension of the returned tensor will
    correspond to the dimension numbered permutation[i] of the input.
 ...
 * Mode: standard
 */
class TensorTranspose extends BaseAlgorithm
{
    protected string $algorithmName = 'TensorTranspose';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute TensorTranspose: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create TensorTranspose algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing TensorTranspose: " . $e->getMessage(), 0, $e);
        }
    }
