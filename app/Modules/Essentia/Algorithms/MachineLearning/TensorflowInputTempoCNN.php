...
class TensorflowInputTempoCNN extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create TensorflowInputTempoCNN algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing TensorflowInputTempoCNN: " . $e->getMessage(), 0, $e);
        }
    }
