...
class TensorflowInputVGGish extends BaseAlgorithm
{
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create TensorflowInputVGGish algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing TensorflowInputVGGish: " . $e->getMessage(), 0, $e);
        }
    }
