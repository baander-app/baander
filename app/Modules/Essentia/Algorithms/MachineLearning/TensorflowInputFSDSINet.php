...
Description:
  ...
  This algorithm computes mel bands from an audio frame with the specific
  parametrization required by the FSD-SINet models.
  
  References:
    [1] Fonseca, E., Ferraro, A., & Serra, X. (2021). Improving sound event
  classification by increasing shift invariance in convolutional neural
  networks. arXiv preprint arXiv:2107.00623.
    [2] https://github.com/edufonseca/shift_sec
 * 
 * Category: MachineLearning
 * Mode: standard
 */
class TensorflowInputFSDSINet extends BaseAlgorithm
{
    protected string $algorithmName = 'TensorflowInputFSDSINet';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute TensorflowInputFSDSINet: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create TensorflowInputFSDSINet algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing TensorflowInputFSDSINet: " . $e->getMessage(), 0, $e);
        }
    }
