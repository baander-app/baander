 ...
 * Mode: streaming
 */
class CompositeBase extends BaseAlgorithm
{
    protected string $algorithmName = 'CompositeBase';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute CompositeBase: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create CompositeBase algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing CompositeBase: " . $e->getMessage(), 0, $e);
        }
    }
