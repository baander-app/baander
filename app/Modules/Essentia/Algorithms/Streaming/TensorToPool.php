 ...
 * Mode: streaming
 */
class TensorToPool extends BaseAlgorithm
{
    protected string $algorithmName = 'TensorToPool';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute TensorToPool: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create TensorToPool algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing TensorToPool: " . $e->getMessage(), 0, $e);
        }
    }
