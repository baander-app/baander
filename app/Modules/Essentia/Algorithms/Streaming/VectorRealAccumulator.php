...
namespace App\Modules\Essentia\Algorithms\Streaming;
 ...
 * Mode: streaming
 */
class VectorRealAccumulator extends BaseAlgorithm
{
    protected string $algorithmName = 'VectorRealAccumulator';
    protected string $mode = 'streaming';
    protected string $category = 'Streaming';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute VectorRealAccumulator: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create VectorRealAccumulator algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing VectorRealAccumulator: " . $e->getMessage(), 0, $e);
        }
    }
        ...
        switch ($this->category) {
            ...
            case 'Tonal':
                if (!is_array($input) && !($input instanceof AudioVector)) {
                    throw new AlgorithmException('Streaming algorithms expect array or AudioVector input');
                }
                break;
