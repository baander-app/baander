 ...
 * Mode: streaming
 */
class NSGConstantQStreaming extends BaseAlgorithm
{
    protected string $algorithmName = 'NSGConstantQStreaming';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute NSGConstantQStreaming: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create NSGConstantQStreaming algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing NSGConstantQStreaming: " . $e->getMessage(), 0, $e);
        }
    }
