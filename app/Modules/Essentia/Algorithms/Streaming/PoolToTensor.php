 ...
 * Mode: streaming
 */
class PoolToTensor extends BaseAlgorithm
{
    protected string $algorithmName = 'PoolToTensor';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute PoolToTensor: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create PoolToTensor algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing PoolToTensor: " . $e->getMessage(), 0, $e);
        }
    }
