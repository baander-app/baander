 ...
 * Mode: streaming
 */
class VectorInput extends BaseAlgorithm
{
    protected string $algorithmName = 'VectorInput';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute VectorInput: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create VectorInput algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing VectorInput: " . $e->getMessage(), 0, $e);
        }
    }
