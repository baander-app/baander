 ...
 * Mode: streaming
 */
class VectorRealToTensor extends BaseAlgorithm
{
    protected string $algorithmName = 'VectorRealToTensor';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute VectorRealToTensor: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create VectorRealToTensor algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing VectorRealToTensor: " . $e->getMessage(), 0, $e);
        }
    }
