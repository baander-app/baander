 ...
 * Mode: streaming
 */
class TensorToVectorReal extends BaseAlgorithm
{
    protected string $algorithmName = 'TensorToVectorReal';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute TensorToVectorReal: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create TensorToVectorReal algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing TensorToVectorReal: " . $e->getMessage(), 0, $e);
        }
    }
