 ...
 * Mode: streaming
 */
class BarkExtractor extends BaseAlgorithm
{
    protected string $algorithmName = 'BarkExtractor';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute BarkExtractor: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create BarkExtractor algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing BarkExtractor: " . $e->getMessage(), 0, $e);
        }
    }
