 ...
 * Mode: streaming
 */
class RealAccumulator extends BaseAlgorithm
{
    protected string $algorithmName = 'RealAccumulator';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute RealAccumulator: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create RealAccumulator algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing RealAccumulator: " . $e->getMessage(), 0, $e);
        }
    }
