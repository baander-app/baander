 ...
 * Mode: streaming
 */
class FileOutput extends BaseAlgorithm
{
    protected string $algorithmName = 'FileOutput';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute FileOutput: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create FileOutput algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing FileOutput: " . $e->getMessage(), 0, $e);
        }
    }
