 ...
 * Mode: streaming
 */
class LoudnessEBUR128Filter extends BaseAlgorithm
{
    protected string $algorithmName = 'LoudnessEBUR128Filter';
    ...
    public function compute($input): array
    {
        try {
            ...
            throw new AlgorithmException(
                "Failed to compute LoudnessEBUR128Filter: " . $e->getMessage(),
                0,
                $e
            );
        }
    ...
    private function initializeAlgorithm(): void
    {
        ...
        try {
            ...
            if (!$this->algorithmHandle) {
                throw new AlgorithmException("Failed to create LoudnessEBUR128Filter algorithm instance");
            }
            ...
            throw new AlgorithmException("FFI error initializing LoudnessEBUR128Filter: " . $e->getMessage(), 0, $e);
        }
    }
