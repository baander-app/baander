...
use SwooleBundle\SwooleBundle\Component\Locking\Channel\ChannelPool;
...
use SwooleBundle\SwooleBundle\Server\Configurator\WithWebSocketHandler;
...
return static function (ContainerConfigurator $containerConfigurator): void {
    ...
    $services->set(SwooleServerTaskSender::class)
    ...
    $services->set(\SwooleBundle\SwooleBundle\Bridge\Doctrine\DBAL\DBALPlatformAliveKeeper::class)
        ->arg('$connections', [])
        ->arg('$aliveKeepers', []);
    ...
    $services->set(SystemMetricsProviderRegistry::class)
        ->arg('$metricsProvider', service(SwooleMetricsProvider::class));
