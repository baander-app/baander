...
class HLSFlag
{
     ...
     */
    const string PERIODIC_REKEY = "periodic_rekey";
     ...
     */
    const string SPLIT_BY_TIME = "split_by_time";

    /**
     * Generate EXT-X-PROGRAM-DATE-TIME tags.
     */
    const string PROGRAM_DATE_TIME = "program_date_time";
     ...
     * the required width.
     */
    const string SECOND_LEVEL_SEGMENT_INDEX = "second_level_segment_index";
     ...
     */
    const string SECOND_LEVEL_SEGMENT_SIZE = "second_level_segment_size";
     ...
     */
    const string SECOND_LEVEL_SEGMENT_DURATION = "second_level_segment_duration";
     ...
     */
    const string TEMP_FILE = "temp_file";
}