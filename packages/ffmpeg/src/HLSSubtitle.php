...
{
    /** @const string */
    private const string S_TAG = "#EXTM3U";

    /** @const string */
    private const string E_TAG = "#EXT-X-ENDLIST";

    /** @const string */
    private const array SUPPORTED_EXTS = ['vtt'];
    ...
    public function __toString()
    {
        ...
        $ext = [
            ...
            "DEFAULT"    => Utils::convertBooleanToYesNo($this->isDefault()),
            "AUTOSELECT" => Utils::convertBooleanToYesNo($this->isAutoSelect()),
            "FORCED"     => Utils::convertBooleanToYesNo($this->isForce()),
            "LANGUAGE"   => "\"" . $this->language_code . "\"",
            "URI"        => "\"" . $this->getM3u8Uri() . "\"",
        ];
        Utils::concatKeyValue($ext, "=");
