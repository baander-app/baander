...
use Baander\FFMpeg\Exporters\HLSExporter;
use Baander\FFMpeg\Exporters\MediaExporter;
use Baander\FFMpeg\FFMpeg\ImageFormat;
use Baander\FFMpeg\Filesystem\Disk;
use Baander\FFMpeg\Filesystem\Media;
use Baander\FFMpeg\Filesystem\MediaCollection;
use Baander\FFMpeg\Filesystem\MediaOnNetwork;
use Baander\FFMpeg\Filesystem\TemporaryDirectories;
use Baander\FFMpeg\Filters\TileFactory;

/**
 * @mixin \Baander\FFMpeg\Drivers\PHPFFMpeg
 */
class MediaOpener
{
    use ForwardsCalls;
    ...
    /**
     * @var \Baander\FFMpeg\Filesystem\Disk
     */
    private $disk;

    /**
     * @var \Baander\FFMpeg\Drivers\PHPFFMpeg
     */
    private $driver;

    /**
     * @var \Baander\FFMpeg\Filesystem\MediaCollection
     */
    private $collection;
