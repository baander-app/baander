...
class HLSExporter extends MediaExporter
{
    ...
    */
    ...
    /**
     * @var \Baander\FFMpeg\Exporters\PlaylistGenerator
     */
     ...
     *
     * @param \Baander\FFMpeg\Exporters\PlaylistGenerator $playlistGenerator
     * @return self
     */
     ...
     * @param \Baander\FFMpeg\Filesystem\Disk $disk
     * @param integer $key
     * @return array
     */
     ...
     *
     * @param \Baander\FFMpeg\Filesystem\Media $media
     * @return self
     */
     ...
     *
     * @param string $path
     * @throws \Baander\FFMpeg\Exporters\NoFormatException
     ...
     *
     * @param string $path
     * @return \Baander\FFMpeg\MediaOpener
     */
